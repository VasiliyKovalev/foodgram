# Generated by Django 4.2.16 on 2024-12-05 13:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(upload_to='users/', verbose_name='Изображение рецепта')),
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin')], default='user', max_length=20, verbose_name='Пользовательская роль')),
